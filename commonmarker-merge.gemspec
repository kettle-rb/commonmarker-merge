...
# kettle-jem:freeze
# To retain chunks of comments & code during commonmarker-merge templating:
...
Gem::Specification.new do |spec|
  ...
  spec.summary = "🍲 Intelligent Markdown file merging using Commonmarker AST analysis"
  spec.description = "🍲 Commonmarker::Merge provides smart Markdown file merging using Comrak (Rust) via Commonmarker. It understands document structure including headings, lists, code blocks, and tables. Perfect for merging documentation templates with customized files."
  spec.homepage = "https://github.com/kettle-rb/commonmarker-merge"
  ...
  spec.metadata["homepage_uri"] = "https://commonmarker-merge.galtzo.com/"
  ...
  # The 'git' gem is optional; commonmarker-merge falls back to shelling out to `git` if it is not present.
