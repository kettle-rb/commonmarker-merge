...
# commonmarker-merge Rakefile v1.0.0 - 2026-04-03
...
# rake install                                # Build and install commonmarker-merge-1.0.0.gem in...
# rake install:local                          # Build and install commonmarker-merge-1.0.0.gem in...
# rake kettle:jem:install                     # Install commonmarker-merge GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template commonmarker-merge against itse...
# rake kettle:jem:template                    # Template commonmarker-merge files into the curren...
