...
module Commonmarker
  module Merge
    ...
    class TableMatchAlgorithm
      ...
      #
      # @param table_a [Commonmarker::Node] First table node
      # @param table_b [Commonmarker::Node] Second table node
      ...
      #
      # @param table [Commonmarker::Node] Table node
      ...
      #
      # @param row [Commonmarker::Node] Table row node
      ...
      #
      # @param node [Commonmarker::Node] Node to extract text from
