...
RSpec.describe Commonmarker::Merge::TableMatchRefiner do
  ...
  describe "#call" do
    ...
    let(:template_analysis) { Commonmarker::Merge::FileAnalysis.new(template_md) }
    let(:dest_analysis) { Commonmarker::Merge::FileAnalysis.new(dest_md) }
