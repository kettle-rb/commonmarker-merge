...
RSpec.describe "Branch Coverage" do
  ...
  describe Commonmarker::Merge::SmartMerger do
  ...
  describe Commonmarker::Merge::FileAligner do
  ...
  describe Commonmarker::Merge::ConflictResolver do
